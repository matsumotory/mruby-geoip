...
void mrb_mruby_geoip_gem_init(mrb_state *mrb)
{
    ...
    mrb_define_method(mrb, geoip, "initialize", mrb_geoip_init, MRB_ARGS_REQ(2));
    mrb_define_method(mrb, geoip, "record_by_name", mrb_geoip_record_by_name, MRB_ARGS_NONE());
    mrb_define_method(mrb, geoip, "record_by_addr", mrb_geoip_record_by_addr, MRB_ARGS_NONE());
